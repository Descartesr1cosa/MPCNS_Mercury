...
inline std::vector<FieldSpec> FieldSpecs()
{
    ...
    return {
        ...
        {"B_xi", StaggerLocation::FaceXi, 1, UseRuntimeGhost, "",
         SyncContract("Bface", true, true, true, HaloLevel::Vertex, OwnerSyncPolicy::FaceOwner, true),
        ...
        {"E_xi", StaggerLocation::EdgeXi, 1, UseRuntimeGhost, "",
         SyncContract("Eedge", true, true, true, HaloLevel::Vertex, OwnerSyncPolicy::EdgeOwner, true),
        ...
        {"J_xi", StaggerLocation::EdgeXi, 1, UseRuntimeGhost, "",
         SyncContract("Jedge", true, true, true, HaloLevel::Vertex, OwnerSyncPolicy::EdgeOwner, true),
         FieldValueKind::EdgeCovariant1Form},
        ...
        {"Badd_xi", StaggerLocation::FaceXi, 1, UseRuntimeGhost, "",
         SyncContract("Badd", true, true, true, HaloLevel::Vertex, OwnerSyncPolicy::FaceOwner, true),
         FieldValueKind::FaceContravariant2Form},
        ...
        {"dE_xi", StaggerLocation::EdgeXi, 1, UseRuntimeGhost, "",
         SyncContract("dE", true, true, true, HaloLevel::Vertex, OwnerSyncPolicy::EdgeOwner, true),
         FieldValueKind::EdgeCovariant1Form},
        ...
        {"dB_xi", StaggerLocation::FaceXi, 1, UseRuntimeGhost, "",
         SyncContract("dB", true, true, true, HaloLevel::Vertex, OwnerSyncPolicy::FaceOwner, true),
         FieldValueKind::FaceContravariant2Form},
        ...
        {"dJ_xi", StaggerLocation::EdgeXi, 1, UseRuntimeGhost, "",
         SyncContract("dJ", true, true, true, HaloLevel::Vertex, OwnerSyncPolicy::EdgeOwner, true),
         FieldValueKind::EdgeCovariant1Form},
        ...
        {"dEpre_xi", StaggerLocation::EdgeXi, 1, UseRuntimeGhost, "",
         SyncContract("dEpre", true, true, true, HaloLevel::Vertex, OwnerSyncPolicy::EdgeOwner, true),
         FieldValueKind::EdgeCovariant1Form},
