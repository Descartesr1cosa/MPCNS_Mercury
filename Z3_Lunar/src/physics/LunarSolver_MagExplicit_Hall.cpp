...
double LunarSolver::HallRadialTaper_(double x, double y, double z)
{
...
double LunarSolver::HallRadialTaperEdge_(int ib, StaggerLocation loc, int i, int j, int k)
{
...
void LunarSolver::AssembleSingularEdgeEMF_HallExplicit_()
{
                             ...
                             const METRIC::WeightedIncidentEntity &inc)->double
    {
        ...
        if(!bc.is_allocated()||!jc.is_allocated()||!uh.is_allocated()) return 0.0;
