...
{
    // Z4: owner synchronization is driven by FieldSyncContract::owner_sync
    // and executed by Halo::sync_group/sync_registered. The legacy explicit
    // EdgeOwnerSyncPattern path is no longer enabled here.
    (void)g;
}
