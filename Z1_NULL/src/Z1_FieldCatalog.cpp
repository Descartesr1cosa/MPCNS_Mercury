...
namespace Z1
{
    void RegisterFields(Field &field, Param &param, int nghost)
    {
        ...
        field.register_field(descriptor("U", StaggerLocation::Cell, FieldValueKind::ConservedVector,
                                        5, nghost, sync_contract("U", true, true, true)));
        field.register_field(descriptor("V", StaggerLocation::Cell, FieldValueKind::CartesianVector,
                                        3, nghost, sync_contract("V", true, true, true)));
        field.register_field(descriptor("rho", StaggerLocation::Cell, FieldValueKind::Scalar,
                                        1, nghost, sync_contract("rho", true, true, true)));

        field.register_field(descriptor("B_xi", StaggerLocation::FaceXi, FieldValueKind::FaceContravariant2Form,
                                        1, nghost, sync_contract("Bface", true, true, true, HaloLevel::Vertex, true, OwnerSyncPolicy::FaceOwner)));
        ...
        field.register_field(descriptor("E_xi", StaggerLocation::EdgeXi, FieldValueKind::EdgeCovariant1Form,
                                        1, nghost, sync_contract("Eedge", true, true, true, HaloLevel::Vertex, true, OwnerSyncPolicy::EdgeOwner)));
        ...
        field.register_field(descriptor("RHS_U", StaggerLocation::Cell, FieldValueKind::ConservedVector,
                                        5, 0, sync_contract("RHS_U", false, false, false, HaloLevel::FaceOnly)));
        field.register_field(descriptor("RHS_B_xi", StaggerLocation::FaceXi, FieldValueKind::FaceContravariant2Form,
                                        1, 0, sync_contract("RHS_B", false, false, false, HaloLevel::FaceOnly)));
        field.register_field(descriptor("RHS_B_eta", StaggerLocation::FaceEt, FieldValueKind::FaceContravariant2Form,
                                        1, 0, sync_contract("RHS_B", false, false, false, HaloLevel::FaceOnly)));
        field.register_field(descriptor("RHS_B_zeta", StaggerLocation::FaceZe, FieldValueKind::FaceContravariant2Form,
                                        1, 0, sync_contract("RHS_B", false, false, false, HaloLevel::FaceOnly)));

        field.register_field(descriptor("tmp", StaggerLocation::Cell, FieldValueKind::Temporary,
                                        1, 0, sync_contract("tmp", false, false, false, HaloLevel::FaceOnly)));
    }
