...
void LunarBoundary::BC_Pole_Bcell_Collapse_(FieldBlock &U, Field *fld,
...
void LunarBoundary::BC_Solid_Surface_Jcell(FieldBlock &U, Field *fld, const BOUND::PhysicalRegion &r, int ngh)
{
    const Box3 &inner = r.inner_slab;
...
void LunarBoundary::BC_Pole_Bface_Collapse_(FieldBlock &U, Field *fld,
                                              const BOUND::PhysicalRegion &r,
                                              int ngh)
{
...
void LunarBoundary::BC_Solid_Surface_Eface_(FieldBlock &U, Field *fld, const BOUND::PhysicalRegion &r, int ngh)
{
...
void LunarBoundary::BC_Solid_Surface_Eface_ghots_zero(FieldBlock &U, Field *fld, const BOUND::PhysicalRegion &r, int ngh)
{
    bool is_norm = false;
...
void LunarBoundary::BC_Solid_Surface_Eedge_(FieldBlock &U, Field *fld, const BOUND::PhysicalRegion &r, int ngh)
{
